...
_overall avg score: 5.111 · weights pull toward neutral until a tag has 3+ posts_

### By format
- ▲ **comment** — weight 1.397  ·  3 post(s)
- ▲ **stat** — weight 1.184  ·  3 post(s)
- ▬ **social** — weight 1.047  ·  2 post(s)  _(only 2, low confidence)_
- ▬ **statement** — weight 0.963  ·  5 post(s)
...
- ▼ **algorithm** — weight 0.874  ·  5 post(s)
- ▼ **editing** — weight 0.653  ·  3 post(s)

### By visual style
- ▲ **blackout** — weight 1.324  ·  2 post(s)  _(only 2, low confidence)_
- ▲ **ember** — weight 1.305  ·  5 post(s)
