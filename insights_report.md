...
_overall avg score: 5.154 · weights pull toward neutral until a tag has 3+ posts_

### By format
- ▲ **comment** — weight 1.39  ·  3 post(s)
- ▲ **stat** — weight 1.181  ·  3 post(s)
- ▬ **social** — weight 1.043  ·  2 post(s)  _(only 2, low confidence)_
- ▬ **statement** — weight 0.958  ·  5 post(s)
- ▬ **quote** — weight 0.958  ·  2 post(s)  _(only 2, low confidence)_
- ▬ **typewriter** — weight 0.952  ·  1 post(s)  _(only 1, low confidence)_
- ▼ **sequence** — weight 0.896  ·  2 post(s)  _(only 2, low confidence)_
- ▼ **imessage** — weight 0.894  ·  4 post(s)
- ▼ **carousel** — weight 0.836  ·  7 post(s)

### By topic / pillar
- ▲ **hook** — weight 1.193  ·  9 post(s)
- ▲ **general** — weight 1.083  ·  6 post(s)
- ▬ **business** — weight 1.037  ·  5 post(s)
- ▼ **proof** — weight 0.912  ·  1 post(s)  _(only 1, low confidence)_
- ▼ **algorithm** — weight 0.878  ·  5 post(s)
- ▼ **editing** — weight 0.662  ·  3 post(s)

### By visual style
- ▲ **blackout** — weight 1.32  ·  2 post(s)  _(only 2, low confidence)_
- ▲ **ember** — weight 1.298  ·  5 post(s)
- ▲ **dark** — weight 1.165  ·  3 post(s)
- ▼ **midnight** — weight 0.947  ·  4 post(s)
- ▼ **creamorange** — weight 0.897  ·  3 post(s)
- ▼ **navyorange** — weight 0.893  ·  2 post(s)  _(only 2, low confidence)_
- ▼ **slate** — weight 0.876  ·  4 post(s)
- ▼ **light** — weight 0.866  ·  3 post(s)
...
- ▲ **0** — weight 1.09  ·  14 post(s)
- ▬ **3** — weight 1.01  ·  8 post(s)
