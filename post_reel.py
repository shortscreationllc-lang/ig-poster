...
ROTATION = [
    ...
    {"type": "imessage", "style": "dark",
     "messages": [{"from": "them", "text": "how'd you get over being awkward on camera?"},
                  {"from": "me", "text": "went outside and filmed myself in front of a bunch of people"},
                  {"from": "me", "text": "kept doing it til the fear was gone. reps. that's it"},
                  {"from": "them", "text": "damn so no shortcut"},
                  {"from": "me", "text": "none. but it works fast"}],
     "hook": "How I got comfortable on camera — reps in front of real people."},
    {"type": "imessage", "style": "slate",
     "messages": [{"from": "them", "text": "how do you actually get clients from posting?"},
                  {"from": "me", "text": "show up every single day until they can't ignore you"},
                  {"from": "me", "text": "don't bet on going viral. bet on consistency"},
                  {"from": "them", "text": "that makes a lot of sense"}],
     "hook": "How to get clients from content — show up daily until they can't ignore you."},
